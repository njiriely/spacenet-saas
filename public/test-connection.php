<?php
// public/test-connection.php - Quick Database Test (Delete after setup)
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    try {
        ...
        if ($result['test'] === 1) {
            ...
            echo "<p>Database: " . EnvLoader::get('DB_DATABASE') . "</p>";
            echo "<p>Host: " . EnvLoader::get('DB_HOST') . "</p>";
        }
    } catch (Exception $e) {
    ...
    ?>
    <hr>
    <p><strong>Important:</strong> Delete this file after confirming database connection works!</p>
</body>
</html><?php
